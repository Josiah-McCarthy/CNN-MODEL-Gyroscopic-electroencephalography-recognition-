...
gyro_train_data = pd.read_csv('C:/Users/jo07660/Desktop/FINAL_DATA/Training_gyroraw.csv')
gyro_test_data = pd.read_csv('C:/Users/jo07660/Desktop/FINAL_DATA/Testing_gyroraw.csv')

# Load training and testing data for EEG
eeg_train_data = pd.read_csv('C:/Users/jo07660/Desktop/FINAL_DATA/Training_eegraw.csv')
eeg_test_data = pd.read_csv('C:/Users/jo07660/Desktop/FINAL_DATA/Testing_eegraw.csv')
...
lr_eeg = 0.00001
epoch = 320 # from 10, 24, 32, 64, 120, 320, 500, 600 ....
b_s_eeg = 32 #  from 8, 16, 32, 64 ....
b_s_gyro = 16 #  from 8, 16, 32, 64 ....
hidden_layer = 256 # 24, 64, 200, 256 .....
dropout = 0.2 # from 0.1 to 0.9
...
X_gyro_train = gyro_train_data[['MOT.Q0', 'MOT.Q1', 'MOT.Q2', 'MOT.Q3']].values
Y_gyro_train = gyro_train_data['Label'].values
X_gyro_test = gyro_test_data[['MOT.Q0', 'MOT.Q1', 'MOT.Q2', 'MOT.Q3']].values
...
gyro_model = ImprovedGestureClassifier_gyro(num_classes=3, input_channels_gyro=4)
...
eeg_model = ImprovedGestureClassifier_eeg(num_classes=3, input_channels_eeg=2)
...
# save model
save_dir = 'C:/Users/jo07660/Desktop/FINAL_DATA/new'
